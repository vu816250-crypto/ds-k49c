...
div.innerHTML = `
${s.stt} - ${s.id} - ${s.name}
<button onclick="selectStudent('${s.id}','${s.name}')">Chọn</button>
`
...
document.getElementById("sv").innerText =
id + " - " + name
...
let diem = document.getElementById("diem_bcs").value

let vang = document.getElementById("ngay_vang").value
